...
echo "<div style='color:#0000AA;font-size:16px'><br/><br/><b>Form a  sentence (Declarative or Interrogative or any other type) from all of the given words</b></div><div style='color:#0000FF;font-size:14px' <b><i>(select the buttons in proper order, the submit button won't appear unless all buttons are used to make the sentence) </i></b><br/><br/></div>";
